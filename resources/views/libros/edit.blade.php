...
<form name="editar" action="{{route('libros.update', $libro)}}" method="POST">
    @csrf
    @method('PUT')
        <div class="row">
          <div class="col">
        ...
        <div class="row mt-3">
                ...
                <div class="col">
                  <input type="text" class="form-control" value="{{$libro->stock}}" min="0" name="stock" step="1">
                </div>               
              </div>
              <div class="row mt-3">
                    <div class="col">
                        <label for="ta" class="normal">Sinopsis</label>
                        <textarea class="form-control" name="sinopsis"  id="a" cols="30" rows="4" required>{{$libro->sinopsis}}</textarea>
                    </div>
