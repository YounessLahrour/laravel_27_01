...
class LibroController extends Controller
{
    ...
    public function mostrarTodos(){
        //simplePaginate
        $libros=Libro::orderBy('id')->paginate(2);
    ...
    public function store(Request $request)
    {
        ...
        //os dejo abierto controlar si no paso el validate
        Libro::create($request->all());
        Session::flash('mensaje', 'Libro creado correctamente');
        return redirect()->route('libros.mostrar');
    }
    ...
    public function update(Request $request, Libro $libro)
    {
        ...
        Session::flash('mensaje', 'Libro modificado correctamente');
        return redirect()->route('libros.mostrar');
    }
    ...
    {
        $libro->delete();
        //Pasamos mensaje de libro borrado correctamente
